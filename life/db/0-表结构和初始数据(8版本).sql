...
INSERT INTO `sys_frontend_menu_table` VALUES ('94025c8731dc0dc403b66f9e8899cbc7', '商品查询', 'order.html', '105eb6c65a907eb589dbd3a9eeea013a', 101, '前端的商品查询页面');
...
CREATE TABLE `sys_user_table`  (
  ...
  `username` varchar(45) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL COMMENT '用户名称',
